 ...
 * Typings are derived from SolidJS typings
 *
...
declare namespace JSX {
  ...
  interface DOMAttributes<T> extends CustomAttributes<T>, DirectiveAttributes, PropAttributes, AttrAttributes, CSSAttributes, OnAttributes<T>, OnCaptureAttributes<T> {
    "bind:this"?: T;
    children?: Element;
    innerHTML?: string;
  ...
  type CSSPropertiesAll = CSSPropertiesHyphen & CSSPropertiesNoHyphen;
  interface CSSProperties extends CSSPropertiesAll {
    // Override
  ...
  type CSSKeys = Exclude<keyof CSSPropertiesAll, `-${string}`>;

  type CSSAttributes = {
    [key in CSSKeys as `style:${key}`]?: CSSPropertiesAll[key];
  };
  ...
  interface ForMangoAttributes {
    of: Array<any>;
    render: (item: any, index?: number) => any;
  }
  interface LazyMangoAttributes extends CSSAttributes {
    "lazy:src": string;
    "lazy:glob"?: string;
    "lazy:loader": JSX.Element;
